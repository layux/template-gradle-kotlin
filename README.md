# Plantilla: Gradle & Kotlin

Este repositorio es una plantilla base para la creación de proyectos de Java y Kotlin, que emplea Gradle como sistema de compilación.
